...
CommandoX encourages pull requests.  When submitting a pull request:
 ...
 - Target the `master` branch (not `dev`, a target cut for composer bravehearts)
...
### v0.5.0 (MULTPLE BREAKING CHANGES)

 - Upgrade to PHP 7.2
 - remove PHP 5.x from travis CI yaml / testing
 - strict_types on everywhere
 - method parameter and return type hints enforced
